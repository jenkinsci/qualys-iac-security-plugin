...
import com.qualys.plugins.commons.JenkinsUtil;
import com.qualys.plugins.commons.model.*;
import com.qualys.plugins.commons.model.Util;
import com.qualys.plugins.commons.service.IQualysService;
import com.qualys.plugins.validation.UIJenkinsValidation;
import com.qualys.plugins.validation.UIValidation;
import com.qualys.plugins.commons.service.impl.QualysServiceImpl;
...
import com.qualys.plugins.jenkins.dto.QualysApiConfiguration;
import java.io.File;
...
public class TemplateScanBuilder extends Builder implements SimpleBuildStep {
    ...
    private final com.qualys.plugins.commons.model.Util util = com.qualys.plugins.commons.model.Util.getInstance();
    ...
    public void perform(@NonNull Run<?, ?> run, @NonNull FilePath workspace, @NonNull EnvVars env, @NonNull Launcher launcher,
        ...
        com.qualys.plugins.commons.model.Util util = Util.getInstance();
